# Add a marker with a popup to a web map
...
If you would like to remove all of the resources created in this walkthrough, delete the CloudFormation stack called `marker-with-popup-example`.
